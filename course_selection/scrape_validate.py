...
def validate_course(course):
    ...
    section_validator = {
        ...
        "meetings": lambda array: validate_array(
            array, lambda meeting: validate_dict(meeting, meeting_validator)
        ),
    }
    ...
    course_validator = {
        ...
        "professors": lambda array: validate_array(
            array, lambda prof: validate_dict(prof, professor_validator)
        ),
        "course_listings": lambda array: validate_array(
            array, lambda listing: validate_dict(listing, listing_validator)
        ),
        "sections": lambda array: validate_array(
            array, lambda section: validate_dict(section, section_validator)
        ),
    }
