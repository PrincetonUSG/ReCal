...
class UserAuthorization(Authorization):
    def read_list(self, object_list, bundle):
        ...
        filtered = [
            obj for obj in object_list if obj.netid == bundle.request.user.username
        ]
        if len(filtered) > 0:
            return filtered
        else:
...
class UserObjectsOnlyAuthorization(Authorization):
    def read_list(self, object_list, bundle):
        filtered = [
            obj for obj in object_list if obj.user.netid == bundle.request.user.username
        ]
        return filtered
...
class UserObjectOrFriendAuthorization(UserObjectsOnlyAuthorization):
    ...
    def read_list(self, object_list, bundle):
        filtered = [
            ...
            if self.is_owner_or_friend(bundle.request.user, o.user)
        ]
        return filtered
...
class CourseResource(ModelResource):
    ...
    class Meta:
        ...
        limit = 0
        max_limit = 0
        filtering = {"semester": ALL_WITH_RELATIONS}
...
class ScheduleResource(ModelResource):
    ...
    class Meta:
        ...
        limit = 0
        max_limit = 0
        filtering = {"user": ALL_WITH_RELATIONS, "semester": ALL_WITH_RELATIONS}
...
class FriendResource(ModelResource):
    ...
    class Meta:
        ...
        authorization = Authorization()
        filtering = {"netid": ALL_WITH_RELATIONS}
...
class FriendRequestResource(ModelResource):
    ...
    class Meta:
        ...
        limit = 0
        max_limit = 0
        filtering = {"from_user": ALL_WITH_RELATIONS, "to_user": ALL_WITH_RELATIONS}
