    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        to="course_selection.Nice_User",
                        through="course_selection.Friend_Relationship",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="from_users", to="course_selection.Nice_User"
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            name="to_user",
            field=models.ForeignKey(
                related_name="to_users", to="course_selection.Nice_User"
            ),
            preserve_default=True,
        ),
